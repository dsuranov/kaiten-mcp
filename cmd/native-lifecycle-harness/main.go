...
func main() {
	...
	flag.StringVar(&config.ReleaseRunAttempt, "release-run-attempt", "", "successful Release workflow run attempt")
	...
	flag.StringVar(&config.ReleaseKaitenSHA256, "release-kaiten-sha256", "", "archive-derived SHA-256 for the shipped kaiten binary")
	flag.StringVar(&config.ReleaseKaitenMCPSHA256, "release-kaiten-mcp-sha256", "", "archive-derived SHA-256 for the shipped kaiten-mcp binary")
